  ...
  return (
    <div className="relative overflow-hidden" style={{ width: 1440, height: 900, background: "#F8F7F7" }}>
      <div className="relative z-10 flex flex-col px-[88px] pt-[40px] pb-14 h-full min-h-[900px]">
        ...
        {/* Sub */}
        <p className="font-body leading-relaxed mb-6" style={{ color: "#6B6560", fontSize: 15, maxWidth: 1000 }}>
        ...
        <div className="flex gap-6 flex-1">
          ...
          <div className="flex flex-col gap-5" style={{ flex: "1 1 0", minWidth: 0 }}>
            ...
            {/* Buttons */}
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 12, fontWeight: 500 }}>Buttons · 5 states · matches /components/Button.tsx</p>
            ...
            {/* Choice Row */}
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 12, fontWeight: 500 }}>Choice row · matches /assessment binary item</p>
              <div className="flex items-center gap-3 px-3 py-3" style={{ background: "#F4F2F0", border: "1px solid #DDC8BB" }}>
                <div className="flex items-center justify-center" style={{ width: 18, height: 18, background: "#C4703A", border: "1.5px solid #C4703A", borderRadius: 2 }}>
                  <span style={{ color: "#FFFFFF", fontSize: 12, fontWeight: 500, lineHeight: 1 }}>✓</span>
                </div>
                <span className="font-body" style={{ fontSize: 15, color: "#13100C" }}>Toenails thicker or yellowing. Pain when wearing shoes.</span>
              </div>
            </div>

            {/* Three-state question */}
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 12, fontWeight: 500 }}>Three-state question · matches /assessment pain section</p>
              <div className="px-3 py-3 flex flex-col gap-2" style={{ background: "#F4F2F0", border: "1px solid #DDC8BB" }}>
                <span className="font-body" style={{ fontSize: 15, color: "#13100C" }}>Pain or stiffness in heels first thing in the morning.</span>
                <div className="flex gap-2">
                  <span className="font-body font-bold tracking-[0.08em] px-2.5 py-1" style={{ fontSize: 12, color: "#FFFFFF", background: "#C4703A" }}>YES</span>
                  <span className="font-body font-bold tracking-[0.08em] px-2.5 py-1" style={{ fontSize: 12, color: "#6B6560", background: "#FFFFFF", border: "1px solid #B7B2AE" }}>NO</span>
                  <span className="font-body font-bold tracking-[0.08em] px-2.5 py-1" style={{ fontSize: 12, color: "#6B6560", background: "#FFFFFF", border: "1px solid #B7B2AE" }}>NOT SURE</span>
                </div>
              </div>
            </div>
            ...
            {/* Callout */}
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 12, fontWeight: 500 }}>Callout · info · matches mdx/Callout.tsx</p>
              <div className="rounded-xl px-4 py-3 flex flex-col gap-1" style={{ background: "#F0F2F4", border: "1px solid #BBCDDD" }}>
                ...
                <p className="font-body leading-snug" style={{ fontSize: 12, color: "#6B6560" }}>This is a guide, not a diagnosis. If symptoms are severe, talk to a clinician.</p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-5" style={{ flex: "1 1 0", minWidth: 0 }}>
            ...
            {/* Tags */}
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 12, fontWeight: 500 }}>Tag · 3 variants · matches Card.tsx eyebrow</p>
              <div className="flex items-center gap-2 px-3 py-3">
                <span className="font-body font-bold tracking-[0.10em] px-2.5 py-1" style={{ fontSize: 12, color: "#8C4520", background: "#F4F2F0" }}>NAIL HEALTH</span>
                <span className="font-body font-bold tracking-[0.10em] px-2.5 py-1" style={{ fontSize: 12, color: "#091016", background: "#FFFFFF", border: "1px solid #B7B2AE" }}>FEATURED</span>
                <span className="font-body font-bold tracking-[0.10em] px-2.5 py-1" style={{ fontSize: 12, color: "#1C3F5E", background: "#F0F2F4" }}>ROUTINES</span>
              </div>
            </div>

            {/* Card */}
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 12, fontWeight: 500 }}>Card · matches Card.tsx</p>
              <div className="flex flex-col" style={{ background: "#FFFFFF", boxShadow: "0 1px 2px rgba(0,0,0,0.05)" }}>
                ...
                <div className="px-5 py-4 flex flex-col gap-2">
                  <span className="font-body font-bold tracking-[0.10em] px-2 py-0.5 self-start" style={{ fontSize: 12, color: "#8C4520", background: "#F4F2F0" }}>NAIL HEALTH</span>
                  <h3 className="font-display uppercase leading-tight" style={{ fontSize: 17, color: "#13100C", fontWeight: 500 }}>What actually works for toenail thickening</h3>
                  <p className="font-body leading-snug" style={{ fontSize: 12, color: "#6B6560" }}>After 40, nails change. Most thickening is mechanical, not fungal.</p>
                  <p className="font-body font-semibold mt-1" style={{ fontSize: 12, color: "#1C3F5E" }}>Read the guide →</p>
                </div>
              </div>
            </div>
