      ...
      <div className="relative z-10 flex flex-col px-[88px] pt-[40px] pb-14 h-full min-h-[900px]">
        ...
        <div className="flex gap-6 flex-1">
          ...
          <div className="flex flex-col gap-5" style={{ flex: "1 1 0", minWidth: 0 }}>
            ...
            {/* Buttons */}
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 10, fontWeight: 500 }}>Buttons · 5 states · matches /components/Button.tsx</p>
            ...
            {/* Choice Row */}
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 10, fontWeight: 500 }}>Choice row · matches /assessment binary item</p>
              <div className="flex items-center gap-3 px-3 py-3" style={{ background: "#F4F2F0", border: "1px solid #DDC8BB" }}>
                <div className="flex items-center justify-center" style={{ width: 18, height: 18, background: "#C4703A", border: "1.5px solid #C4703A", borderRadius: 2 }}>
                  <span style={{ color: "#FFFFFF", fontSize: 11, fontWeight: 500, lineHeight: 1 }}>✓</span>
                </div>
            ...
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 10, fontWeight: 500 }}>Three-state question · matches /assessment pain section</p>
            ...
            {/* Callout */}
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 10, fontWeight: 500 }}>Callout · info · matches mdx/Callout.tsx</p>
          ...
          <div className="flex flex-col gap-5" style={{ flex: "1 1 0", minWidth: 0 }}>
            ...
            {/* Tags */}
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 10, fontWeight: 500 }}>Tag · 3 variants · matches Card.tsx eyebrow</p>
            ...
            {/* Card */}
            <div>
              <p className="font-display tracking-[0.15em] uppercase mb-2" style={{ color: "#6B6560", fontSize: 10, fontWeight: 500 }}>Card · matches Card.tsx</p>
              <div className="flex flex-col" style={{ background: "#FFFFFF", boxShadow: "0 1px 2px rgba(0,0,0,0.05)" }}>
                ...
                <div className="px-5 py-4 flex flex-col gap-2">
                  ...
                  <h3 className="font-display uppercase leading-tight" style={{ fontSize: 18, color: "#13100C", fontWeight: 500 }}>What actually works for toenail thickening</h3>
