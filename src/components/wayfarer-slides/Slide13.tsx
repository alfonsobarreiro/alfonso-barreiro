      ...
      <div style={{ border: `1px solid ${wf.n200}`, borderRadius: 8, overflow: "hidden" }}>
        ...
        {routes.map((r, i) => (
          <div key={r[0]} style={{
            ...
            <div className="font-body" style={{ fontSize: "var(--text-body)", fontFamily: "monospace", color: wf.n500 }}>{r[0]}</div>
            <div className="font-body" style={{ fontSize: "var(--text-body)", fontWeight: 500, color: wf.n900 }}>{r[1]}</div>
            <div className="font-body" style={{ fontSize: "var(--text-body)", fontWeight: 500, color: wf.brand500 }}>{r[2]}</div>
            <div className="font-body" style={{ fontSize: "var(--text-body)", color: wf.n700 }}>{r[3]}</div>
          </div>
        ))}
      </div>

      <p className="font-body" style={{
        margin: "24px 0 0", fontSize: "var(--text-body)", lineHeight: 1.5, color: wf.n500, maxWidth: 1100,
      }}>
