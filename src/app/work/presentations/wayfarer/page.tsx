...
export default function WayfarerDeckPage() {
  return (
    <>
      <Nav />
        ...
        <div style={{ padding: "16px clamp(24px, 5vw, 80px) 12px" }}>
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
              ...
              <span style={{ fontFamily: font.sans, fontSize: "13px", color: c.border }}>
                /
              </span>
              <h1 style={{
                fontFamily: font.sans,
            ...
            <p style={{
              ...
              16 Slides · Use arrow keys to advance
            </p>
          </div>
        </div>
