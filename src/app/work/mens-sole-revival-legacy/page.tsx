...
/* Legacy MSR case study (v1). v2 is now the canonical version at
   ...
   and is 404'd in production via the notFound() guard below.
   Robots metadata also locks it out of indexing as a belt-and-suspenders. */

export const metadata: Metadata = {
  title: "Men\u2019s Sole Revival (legacy v1) \u00B7 Local Backup",
  description:
    "Legacy v1 of the MSR case study, kept locally for reference. Canonical case study lives at /work/mens-sole-revival.",
...
const c = {
  ...
  body:        "#3D4440",
  muted:       "#8A8680",
  brand:       "var(--color-brand)",    // Alfonso's brand (C: crimson) — site chrome
  accent:      "var(--color-accent)",   // Alfonso's accent (C: deep teal) — chrome accents
  bg:          "#FFFFFF",
  bgSection:   "#FAFAF9",
  surface:     "#FFFFFF",
  box:         "#FAFAF9",               // off-white callout/info box bg — matches the home About skills box pattern (off-white box on white surface)
  border:      "#DEDCD7",               // neutral gray, not warm tan
  borderStrong:"#A8A6A0",
  cognac:      "#C4703A",               // MSR's own brand — stays only where MSR brand is being SHOWN (positioning triangle, brand comparison data, brand identity exhibits). Chrome cognac has been swapped to c.accent for portfolio cohesion.
};
...
export default function MSRCaseStudyLegacy() {
  // Legacy backup, not for production. 404 anywhere that isn't local dev.
  if (process.env.NODE_ENV === "production") notFound();

  return (
    <>
      <CaseStudySchema
        name="Men’s Sole Revival (legacy v1) · Local Backup"
        description="Legacy v1 of the MSR case study, kept locally for reference. Canonical case study lives at /work/mens-sole-revival."
        slug="mens-sole-revival-legacy"
        dateCreated="2026-04"
      />
      <Nav />
      ...
      <main className="cs-content-wrap" style={{ background: c.bg, paddingTop: "72px" }}>
          ...
          <div style={{ maxWidth: "none", margin: "0 auto" }}>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={label}>
                  <p style={{ fontFamily: font.sans, fontSize: "12px", fontWeight: 500, letterSpacing: "0.01em", textTransform: "uppercase", color: c.accent, margin: "0 0 4px" }}>
                    {label}
                  </p>
                  <p style={{ fontFamily: font.sans, fontSize: "15px", color: "rgba(245,243,239,0.75)", margin: 0 }}>
                    {value}
                  </p>
                </div>
              ))}
              ...
              {[
                ...
                <div key={caption} style={{
                  ...
                  {href ? (
                    ...
                    <span style={{ fontFamily: font.sans, fontSize: "12px", color: c.muted }}>{source}</span>
                  )}
                </div>
              ))}
            </div>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={dim} style={{ background: i % 2 === 0 ? c.surface : c.bg }}>
                      ...
                      <td style={{ ...tdStyle, color: c.accent, fontWeight: 500, textAlign: "center", fontSize: "17px", lineHeight: 1 }}>&rarr;</td>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginTop: "16px", marginBottom: "32px" }}>
              <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                <span style={{
                  ...
                  background: c.accent, flexShrink: 0, marginTop: "9px",
                }} />
                <p style={{
                ...
                <tbody>
                  {[
                    ...
                    <tr key={route} style={{ background: i % 2 === 0 ? c.surface : c.bg }}>
                      <td style={{ ...tdStyle, fontFamily: "monospace", fontSize: "15px", color: c.muted, overflowWrap: "anywhere" }}>{route}</td>
              ...
              {[
                ...
                >
                  <span className="cs-problem-label" style={{
                    fontFamily: font.sans, fontSize: "12px", fontWeight: 500, letterSpacing: "0.01em", textTransform: "uppercase",
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "16px" }}>
                  {[
                    ...
                    <div key={name} style={{
                      ...
                      <p style={{ fontFamily: font.sans, fontSize: "15px", lineHeight: 1.5, color: c.body, margin: 0 }} dangerouslySetInnerHTML={{ __html: desc }} />
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              {[
                ...
                >
                  ...
                  <div>
                    <p style={{ fontFamily: font.sans, fontSize: "12px", fontWeight: 500, letterSpacing: "0.01em", textTransform: "uppercase", color: c.muted, margin: "0 0 6px" }}>
                      {typeface}
                    </p>
                    <p style={{ fontFamily: font.sans, fontSize: "15px", lineHeight: 1.6, color: c.body, margin: 0 }}>
                      {reason}
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "16px" }}>
                {[
                  ...
                  <div key={name}>
                    ...
                    <p style={{ fontFamily: font.sans, fontSize: "12px", fontWeight: 500, letterSpacing: "0.01em", textTransform: "uppercase", color: c.ink, margin: "8px 0 2px" }}>
                      {name}
                    </p>
                    <p style={{ fontFamily: "monospace", fontSize: "12px", color: c.muted, margin: 0 }}>
                      {hex}
                    </p>
                  </div>
                ))}
            ...
            <div style={{ margin: "32px 0", border: `1px solid ${c.border}`, overflow: "hidden" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))" }}>
                {[
                  ...
                  >
                    <p style={{ fontFamily: font.sans, fontSize: "12px", fontWeight: 500, letterSpacing: "0.01em", textTransform: "uppercase", color: c.accent, margin: "0 0 8px" }}>
                      {area}
                    </p>
                    <p style={{ fontFamily: font.sans, fontSize: "15px", fontWeight: 500, color: c.ink, margin: "0 0 6px", lineHeight: 1.35 }}>
                      {decision}
                    </p>
                    <p style={{ fontFamily: font.sans, fontSize: "15px", lineHeight: 1.6, color: c.body, margin: 0 }}>
                      {rationale}
          ...
          <Section label="09" title="Design System">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0", margin: "24px 0 32px", border: `1px solid ${c.border}` }}>
              ...
              <div style={{ padding: "28px clamp(20px, 4vw, 36px)", borderBottom: `1px solid ${c.border}`, background: c.surface }}>
                ...
                <p style={{ fontFamily: font.sans, fontSize: "15px", lineHeight: 1.6, color: c.body, margin: 0, maxWidth: "640px" }}>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={token} style={{ background: i % 2 === 0 ? c.surface : c.bg }}>
                      <td style={{ ...tdStyle, fontFamily: "monospace", fontSize: "15px", color: c.muted }}>{token}</td>
                      <td style={tdStyle}>
            ...
            <p style={{ ...bodyText, marginTop: "10px", fontSize: "15px", color: c.muted }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginTop: "24px" }}>
                {[
                  ...
                  <div key={detail} style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                    <span style={{
                      width: "4px", height: "4px", borderRadius: "50%",
                      background: c.accent, flexShrink: 0, marginTop: "7px",
                    }} />
                    <p style={{
        ...
        <div style={{ maxWidth: "none", margin: "0 auto", padding: "0 clamp(24px, 5vw, 80px)" }}>
          ...
          <Section label="10" title="Impact">
            ...
            <div style={{
              ...
              <p style={{ fontFamily: font.sans, fontSize: "15px", lineHeight: 1.6, color: c.body, margin: "0 0 8px" }}>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={hypothesis} style={{ background: i % 2 === 0 ? c.surface : c.bg }}>
                      ...
                      <td style={{ ...tdStyle, fontFamily: "monospace", fontSize: "15px", color: c.accent }}>{threshold}</td>
                      <td style={{ ...tdStyle, fontSize: "15px", color: c.body }}>{rationale}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        >
          <div style={{ maxWidth: "none", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "32px" }}>
            <div style={{ maxWidth: "640px" }}>
              <p style={{ fontFamily: font.sans, fontSize: "12px", fontWeight: 500, letterSpacing: "0.01em", textTransform: "uppercase", color: c.accent, margin: "0 0 12px" }}>
                Source
              </p>
              ...
              <p style={{ fontFamily: font.sans, fontSize: "15px", lineHeight: 1.6, color: "rgba(245,243,239,0.65)", margin: 0 }}>
        ...
        >
          <div style={{ maxWidth: "none", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "24px" }}>
            <div>
              <p style={{ fontFamily: font.sans, fontSize: "12px", fontWeight: 500, letterSpacing: "0.01em", textTransform: "uppercase", color: c.muted, margin: "0 0 8px" }}>
                Next Case Study
              </p>
...
const c2 = {
  ...
  body:      "#3D4440",
  muted:     "#8A8680",
  brand:     "var(--color-brand)",   // Alfonso's brand (C: crimson)
  accent:    "var(--color-accent)",  // Alfonso's accent (C: deep teal)
  bg:        "#FFFFFF",
  bgSection: "#FAFAF9",
  surface:   "#FFFFFF",
  box:       "#FAFAF9",              // off-white callout bg — matches home About skills box pattern
  border:    "#DEDCD7",              // neutral gray, not warm tan
  cognac:    "#C4703A",              // MSR brand — stays only where MSR is being shown as evidence
};
