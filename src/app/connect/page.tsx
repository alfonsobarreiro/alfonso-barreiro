      ...
      <div className="connect-content">
        ...
        <div className="connect-left">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <a href="https://barreiro.com/#work" target="_blank" rel="noopener noreferrer" className="connect-row solid">
              <span style={{ width: 32, height: 32, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, backgroundColor: "#FFFFFF" }}>
                ...
                <img
                  ...
                  width={24}
                  height={11}
                  style={{ objectFit: "contain", filter: "invert(56%) sepia(30%) saturate(700%) hue-rotate(346deg) brightness(85%) contrast(90%)" }}
                />
              </span>
            ...
            <a href="https://wayfarer.barreiro.com/" target="_blank" rel="noopener noreferrer" className="connect-row">
              <span style={{ width: 32, height: 32, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, backgroundColor: "#C17F4A" }}>
                <WayfarerGlobe />
              </span>
        ...
        <div className="connect-right">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            >
              <span style={{ width: 32, height: 32, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, backgroundColor: "#FFFFFF" }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C17F4A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
